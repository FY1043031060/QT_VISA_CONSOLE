...
#define NIDCPOWER_MINOR_VERSION                9     /* Instrument driver minor version   */
...
#define NIDCPOWER_ATTR_PULSE_VOLTAGE_LEVEL               NIDCPOWER_ATTR_BASE + 80L               /* ViReal64,  multi-channel, volts    */
#define NIDCPOWER_ATTR_PULSE_CURRENT_LIMIT               NIDCPOWER_ATTR_BASE + 81L               /* ViReal64,  multi-channel, amps     */
#define NIDCPOWER_ATTR_PULSE_BIAS_VOLTAGE_LEVEL          NIDCPOWER_ATTR_BASE + 82L               /* ViReal64,  multi-channel, volts    */
#define NIDCPOWER_ATTR_PULSE_BIAS_CURRENT_LIMIT          NIDCPOWER_ATTR_BASE + 83L               /* ViReal64,  multi-channel, amps     */
#define NIDCPOWER_ATTR_PULSE_VOLTAGE_LEVEL_RANGE         NIDCPOWER_ATTR_BASE + 84L               /* ViReal64,  multi-channel, volts    */
#define NIDCPOWER_ATTR_PULSE_CURRENT_LIMIT_RANGE         NIDCPOWER_ATTR_BASE + 85L               /* ViReal64,  multi-channel, amps     */

     /*- Pulse Current Output Function Configuration -*/
#define NIDCPOWER_ATTR_PULSE_CURRENT_LEVEL               NIDCPOWER_ATTR_BASE + 86L               /* ViReal64,  multi-channel, amps     */
#define NIDCPOWER_ATTR_PULSE_VOLTAGE_LIMIT               NIDCPOWER_ATTR_BASE + 87L               /* ViReal64,  multi-channel, volts    */
#define NIDCPOWER_ATTR_PULSE_BIAS_CURRENT_LEVEL          NIDCPOWER_ATTR_BASE + 88L               /* ViReal64,  multi-channel, amps     */
#define NIDCPOWER_ATTR_PULSE_BIAS_VOLTAGE_LIMIT          NIDCPOWER_ATTR_BASE + 89L               /* ViReal64,  multi-channel, volts    */
#define NIDCPOWER_ATTR_PULSE_CURRENT_LEVEL_RANGE         NIDCPOWER_ATTR_BASE + 90L               /* ViReal64,  multi-channel, amps     */
#define NIDCPOWER_ATTR_PULSE_VOLTAGE_LIMIT_RANGE         NIDCPOWER_ATTR_BASE + 91L               /* ViReal64,  multi-channel, volts    */
...
#define NIDCPOWER_ATTR_PULSE_BIAS_DELAY                  NIDCPOWER_ATTR_BASE + 92L               /* ViReal64,  multi-channel, seconds  */
#define NIDCPOWER_ATTR_PULSE_ON_TIME                     NIDCPOWER_ATTR_BASE + 93L               /* ViReal64,  multi-channel, seconds  */
#define NIDCPOWER_ATTR_PULSE_OFF_TIME                    NIDCPOWER_ATTR_BASE + 94L               /* ViReal64,  multi-channel, seconds  */

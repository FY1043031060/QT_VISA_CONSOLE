 ...
 ****************************************************************************************************/
#define NIHSDIO_MAJOR_VERSION                2     /* Instrument driver major version  */
#define NIHSDIO_MINOR_VERSION                0   /* Instrument driver minor version  */
...
#define NIHSDIO_ATTR_PPMU_CAPABLE_IO_SWITCH_CONTROL          (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 180L)  /* ViInt32 */
#define NIHSDIO_ATTR_ATTRIBUTE_COMMITTAL_STRATEGY            (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 182L)  /* ViInt32 */
...
#define NIHSDIO_ATTR_ACTIVE_LOAD_MODE                        (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 176L)  /* ViInt32, channel-based */
#define NIHSDIO_ATTR_ACTIVE_LOAD_SOURCING_CURRENT_VALUE      (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 177L)  /* ViReal64, channel-based */
#define NIHSDIO_ATTR_ACTIVE_LOAD_SINKING_CURRENT_VALUE       (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 178L)  /* ViReal64, channel-based */
#define NIHSDIO_ATTR_ACTIVE_LOAD_COMMUTATING_VOLTAGE_LEVEL   (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 179L)  /* ViReal64, channel-based */
...
#define NIHSDIO_ATTR_HWC_CUMULATIVE_ERROR_BITS               (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 181L)  /* ViUInt32 */
...
/* Active Load Constants */
/* Active Load Mode Enum */
#define NIHSDIO_VAL_ACTIVE_LOAD_DISABLED                 96
#define NIHSDIO_VAL_ACTIVE_LOAD_ENABLED_WHEN_TRISTATE    97

/* PPMU Capable I/O Switch Constants */
#define NIHSDIO_VAL_CONNECT                              98
#define NIHSDIO_VAL_DISCONNECT                           99

/* Calibration Child Session Type Enum */
#define NIHSDIO_VAL_CALIBRATION_CHILD_SESSION_TYPE_ACQUISITION   0
#define NIHSDIO_VAL_CALIBRATION_CHILD_SESSION_TYPE_GENERATION    1

/* Calibration Types Enum */
#define NIHSDIO_VAL_CALIBRATION_TYPE_UNCONFIGURED                          0
#define NIHSDIO_VAL_CALIBRATION_TYPE_VOLTAGE_REFERENCE_ADJUST              1
#define NIHSDIO_VAL_CALIBRATION_TYPE_SOURCE_RESISTOR_ADJUST                2
#define NIHSDIO_VAL_CALIBRATION_TYPE_SINK_RESISTOR_ADJUST                  3
#define NIHSDIO_VAL_CALIBRATION_TYPE_CALIBRATION_PULSE_ADJUST              4
#define NIHSDIO_VAL_CALIBRATION_TYPE_INPUT_CHANNEL_SKEW_ACCURACY_VERIFY    5
#define NIHSDIO_VAL_CALIBRATION_TYPE_OUTPUT_CHANNEL_SKEW_ACCURACY_VERIFY   6
#define NIHSDIO_VAL_CALIBRATION_TYPE_INPUT_VOLTAGE_ACCURACY_VERIFY         7
#define NIHSDIO_VAL_CALIBRATION_TYPE_OUTPUT_VOLTAGE_ACCURACY_VERIFY        8
#define NIHSDIO_VAL_CALIBRATION_TYPE_INPUT_CHANNEL_SKEW_ADJUST             9
#define NIHSDIO_VAL_CALIBRATION_TYPE_OUTPUT_CHANNEL_SKEW_ADJUST            10

/* Attribute Committal Strategy */
#define NIHSDIO_VAL_DEFERRED_UNTIL_COMMIT                0
#define NIHSDIO_VAL_IMMEDIATELY_UPON_SET_VOLTAGE         1
...
#define NIHSDIO_VAL_PFI4_STR                             "PFI4"
#define NIHSDIO_VAL_PFI5_STR                             "PFI5"
#define NIHSDIO_VAL_PFI24_STR                            "PFI24"
#define NIHSDIO_VAL_PFI25_STR                            "PFI25"
#define NIHSDIO_VAL_PFI26_STR                            "PFI26"
#define NIHSDIO_VAL_PFI27_STR                            "PFI27"
#define NIHSDIO_VAL_PFI28_STR                            "PFI28"
#define NIHSDIO_VAL_PFI29_STR                            "PFI29"
#define NIHSDIO_VAL_PFI30_STR                            "PFI30"
#define NIHSDIO_VAL_PFI31_STR                            "PFI31"
...
ViStatus _VI_FUNC niHSDIO_ReadStaticU32 (
   ViSession vi,
   ViUInt32* data);
ViStatus _VI_FUNC niHSDIO_WriteStaticPFIU32 (
   ViSession vi, ViUInt32 writeData,
   ViUInt32 channelMask);
ViStatus _VI_FUNC niHSDIO_ReadStaticPFIU32 (
   ViSession vi,
   ViUInt32* data);
...
ViStatus _VI_FUNC niHSDIO_ConfigurePatternMatchStartTriggerU32 (
   ...
   ViUInt32 pattern,
   ViInt32 triggerWhen);
ViStatus _VI_FUNC niHSDIO_ConfigureMultiSamplePatternMatchStartTrigger (
   ViSession vi,
   ViConstString channelList,
   ViConstString pattern);
ViStatus _VI_FUNC niHSDIO_ConfigureMultiSamplePatternMatchStartTriggerU32 (
   ViSession vi,
   ViConstString channelList,
...
ViStatus _VI_FUNC niHSDIO_ConfigurePatternMatchAdvanceTriggerU32 (
   ...
   ViUInt32 pattern,
   ViInt32 triggerWhen);
ViStatus _VI_FUNC niHSDIO_ConfigureMultiSamplePatternMatchAdvanceTrigger (
   ViSession vi,
   ViConstString channelList,
   ViConstString pattern);
ViStatus _VI_FUNC niHSDIO_ConfigureMultiSamplePatternMatchAdvanceTriggerU32 (
   ViSession vi,
   ViConstString channelList,
   ViUInt32 patternArray[],
   ViInt32 numberOfPatterns);
...
ViStatus _VI_FUNC niHSDIO_ConfigurePatternMatchRefTriggerU32 (
   ...
   ViInt32 triggerWhen,
   ViInt32 pretrigSamples);
ViStatus _VI_FUNC niHSDIO_ConfigureMultiSamplePatternMatchRefTrigger (
   ViSession vi,
   ViConstString channelList,
   ViConstString pattern,
   ViInt32 pretrigSamples);
ViStatus _VI_FUNC niHSDIO_ConfigureMultiSamplePatternMatchRefTriggerU32 (
   ViSession vi,
   ViConstString channelList,
   ViUInt32 patternArray[],
   ViInt32 numberOfPatterns,
...
ViStatus _VI_FUNC niHSDIO_InitExtCal (
   ...
   ViSession *vi);
ViStatus _VI_FUNC niHSDIO_CalConfigureDeviceState (
   ViSession vi,
   ViInt32 connector,
   ViUInt32 calibrationType,
   ViUInt32 calibrationReference);
ViStatus _VI_FUNC niHSDIO_CalConfigureChannelState (
   ViSession vi,
   ViConstString channel,
   ViUInt32 calibrationType,
   ViUInt32 calibrationReference);
ViStatus _VI_FUNC niHSDIO_CalAdjustViReal64 (
   ViSession vi,
   ViConstString channel,
   ViUInt32 calibrationType,
   ViUInt32 calibrationReference,
   ViReal64 value);
ViStatus _VI_FUNC niHSDIO_CalAdjustViReal64Array (
   ViSession vi,
   ViConstString channel,
   ViUInt32 calibrationType,
   ViUInt32 calibrationReference,
   ...
   ViReal64 values[]);
ViStatus _VI_FUNC niHSDIO_CalClearState (
   ViSession vi);
ViStatus _VI_FUNC niHSDIO_CalInitChildSession (
   ViSession vi,
   ViUInt8 sessionType,
   ViSession *childSession);
ViStatus _VI_FUNC niHSDIO_CalCloseChildSession (
   ViSession vi,
   ViSession childSession);
...
ViStatus _VI_FUNC niHSDIO_GetExtCalLastTemp (
   ViSession vi,
   ViReal64* temp);
ViStatus _VI_FUNC niHSDIO_ReadCurrentTemperature (
   ViSession vi,
   ViReal64* temp);
...
#define NIHSDIO_ERROR_INVALID_START_WRITE_ADDRESS                             (IVI_SPECIFIC_ERROR_BASE + 33L)
...
#define NIHSDIO_ERROR_INVALID_WAVEFORM_NAME                                   (IVI_SPECIFIC_ERROR_BASE + 38L)
...
#define NIHSDIO_ERROR_MULTI_SAMPLE_PATTERN_MATCH_WITH_DDR_NOT_SUPPORTED       (IVI_SPECIFIC_ERROR_BASE + 132L)
#define NIHSDIO_ERROR_TOO_MANY_PATTERN_SAMPLES_GIVEN                          (IVI_SPECIFIC_ERROR_BASE + 133L)
#define NIHSDIO_ERROR_RF_EDGES_IN_SAMPLES_AFTER_FIRST_NOT_SUPPORTED           (IVI_SPECIFIC_ERROR_BASE + 134L)
#define NIHSDIO_ERROR_MULTI_SAMPLE_PATTERN_MATCH_INVALID_TRIGGER_WHEN_SETTING (IVI_SPECIFIC_ERROR_BASE + 135L)
#define NIHSDIO_ERROR_PFI_RESERVATION_CONFLICT                                (IVI_SPECIFIC_ERROR_BASE + 136L)
#define NIHSDIO_ERROR_MUST_ASSIGN_STATIC_PFI_BEFORE_TRISTATE                  (IVI_SPECIFIC_ERROR_BASE + 137L)
#define NIHSDIO_ERROR_NOT_A_SUBSET_OF_ASSIGNED_DYNAMIC_CHANNELS               (IVI_SPECIFIC_ERROR_BASE + 138L)
#define NIHSDIO_ERROR_AUX_IO_CONNECTOR_NOT_SUPPORTED                          (IVI_SPECIFIC_ERROR_BASE + 139L)
#define NIHSDIO_ERROR_MISMATCHED_PFI_ATTR_CONFIGURATION                       (IVI_SPECIFIC_ERROR_BASE + 140L)
#define NIHSDIO_ERROR_INVALID_VOLTAGE_RANGE_ON_PFI_OR_CLOCK_LINE              (IVI_SPECIFIC_ERROR_BASE + 141L)
#define NIHSDIO_ERROR_CHILD_SESSION_ALREADY_INITIALIZED                       (IVI_SPECIFIC_ERROR_BASE + 142L)
#define NIHSDIO_ERROR_INVALID_SESSION_TYPE                                    (IVI_SPECIFIC_ERROR_BASE + 143L)
#define NIHSDIO_ERROR_UNRECOGNIZED_CHILD_SESSION                              (IVI_SPECIFIC_ERROR_BASE + 144L)
#define NIHSDIO_ERROR_CAL_INVALID_CALIBRATION_REFERENCE_NUMBER                (IVI_SPECIFIC_ERROR_BASE + 145L)
#define NIHSDIO_ERROR_CAL_INVALID_CALIBRATION_TYPE                            (IVI_SPECIFIC_ERROR_BASE + 146L)
#define NIHSDIO_ERROR_CAL_INVALID_ARRAY_SIZE                                  (IVI_SPECIFIC_ERROR_BASE + 147L)
#define NIHSDIO_ERROR_CAL_PULSE_ADJUST_REFERENCE_STEPS_OUT_OF_ORDER           (IVI_SPECIFIC_ERROR_BASE + 148L)
#define NIHSDIO_ERROR_CAL_ADJUST_STEP_MISSING                                 (IVI_SPECIFIC_ERROR_BASE + 149L)
#define NIHSDIO_ERROR_CAL_INVALID_CONNECTOR_SPECIFIED                         (IVI_SPECIFIC_ERROR_BASE + 150L)
#define NIHSDIO_ERROR_CAL_VALUE_OUT_OF_RANGE                                  (IVI_SPECIFIC_ERROR_BASE + 151L)

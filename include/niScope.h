 ...
 ****************************************************************************/
#define NISCOPE_MAJOR_VERSION         4     /* Instrument driver major version */
#define NISCOPE_MINOR_VERSION         100   /* Instrument driver minor version */
...
#define NISCOPE_ATTR_SAMP_CLK_TIMEBASE_MULT              (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 367L)  /* ViInt32    */

   /* New attributes for NI-SCOPE 4.0 */
/* Peer-to-Peer */
#define NISCOPE_ATTR_P2P_STREAM_RELATIVE_TO              (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 373L)  /* ViInt32    */
#define NISCOPE_ATTR_P2P_SAMPLES_TRANSFERRED_PER_RECORD  (IVI_SPECIFIC_PUBLIC_ATTR_BASE + 380L)  /* ViInt32    */

/****************************************************************************
 *------------------ Attribute and Parameter Value Defines -----------------*
 ****************************************************************************/
/*- NISCOPE_ATTR_RIS_METHOD Values -*/
...
/* niScope_SendSoftwareTriggerEdge() Values for whichTrigger */
...
/*- NISCOPE_ATTR_FETCH_RELATIVE_TO Values -*/
...
/* Streaming types for NISCOPE_ATTR_P2P_STREAM_RELATIVE_TO */
#define NISCOPE_VAL_STREAM_RELATIVE_TO_START_TRIGGER        0
#define NISCOPE_VAL_STREAM_RELATIVE_TO_REFERENCE_TRIGGER    1
#define NISCOPE_VAL_STREAM_RELATIVE_TO_SYNC_TRIGGER         2
...
ViStatus _VI_FUNC niScope_ResetAllAttributes(ViSession vi);
...
ViStatus _VI_FUNC niScope_GetStreamEndpointHandle (ViSession vi,
...
#define NISCOPE_ERROR_PATTERN_NOISE_SAMPLE_WORDS      (IVI_SPECIFIC_ERROR_BASE+0X03AL)
#define NISCOPE_ERROR_PATTERN_NOISE_INPUT_EXPECTATION (IVI_SPECIFIC_ERROR_BASE+0X03BL)
#define NISCOPE_ERROR_INVALID_SESSION                 0xBFFA1190
#define NISCOPE_ERROR_1MOHM_PATH_BANDWIDTH_LIMITED    (IVI_SPECIFIC_ERROR_BASE+0X03CL)
#define NISCOPE_ERROR_EXT_CAL_STEP_OUT_OF_ORDER       (IVI_SPECIFIC_ERROR_BASE+0X03DL)
#define NISCOPE_ERROR_MULTIPLES_2_ALLOWED_SAMPLE_CLK_TIMEBASE_DIV    (IVI_SPECIFIC_ERROR_BASE+0X03EL)
#define NISCOPE_ERROR_CAL_INPUT_VOLTAGE_DETECTED      (IVI_SPECIFIC_ERROR_BASE+0X03FL)
#define NISCOPE_ERROR_EXT_CAL_ATTENUATOR_FAILED       (IVI_SPECIFIC_ERROR_BASE+0X040L)
#define NISCOPE_ERROR_TDC_CAL_TIME_OUT            (IVI_SPECIFIC_ERROR_BASE+0X041L)
#define NISCOPE_ERROR_TDC_CAL_FAILURE             (IVI_SPECIFIC_ERROR_BASE+0X042L)
#define NISCOPE_ERROR_TRIGGER_CAL_FAILURE         (IVI_SPECIFIC_ERROR_BASE+0X043L)
#define NISCOPE_ERROR_OFFSET_DAC_CAL_FAILURE          (IVI_SPECIFIC_ERROR_BASE+0X044L)

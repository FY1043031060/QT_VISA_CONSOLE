...
#define DAQmx_Cal_UserDefinedInfo                                        0x1861 // Specifies a string that contains arbitrary, user-defined information. This number of characters in this string can be no more than DAQmx_Cal_UserDefinedInfo_MaxSize.
#define DAQmx_Cal_UserDefinedInfo_MaxSize                                0x191C // Indicates the maximum length in characters of DAQmx_Cal_UserDefinedInfo.
...
#define DAQmx_AI_Thrmcpl_CJCVal                                          0x1036 // Specifies the temperature of the cold junction if DAQmx_AI_Thrmcpl_CJCSrc is DAQmx_Val_ConstVal. Specify this value in the units of the measurement.
#define DAQmx_AI_Thrmcpl_CJCChan                                         0x1034 // Indicates the channel that acquires the temperature of the cold junction if DAQmx_AI_Thrmcpl_CJCSrc is DAQmx_Val_Chan. If the channel is a temperature channel, NI-DAQmx acquires the temperature in the correct units. Other channel types, such as a resistance channel with a custom sensor, must use a custom scale to scale values to degrees Celsius.
...
#define DAQmx_AI_LVDT_Sensitivity                                        0x0939 // Specifies the sensitivity of the LVDT. This value is in the units you specify with DAQmx_AI_LVDT_SensitivityUnits. Refer to the sensor documentation to determine this value.
#define DAQmx_AI_LVDT_SensitivityUnits                                   0x219A // Specifies the units of DAQmx_AI_LVDT_Sensitivity.
#define DAQmx_AI_RVDT_Units                                              0x0877 // Specifies the units to use to return angular position measurements from the channel.
#define DAQmx_AI_RVDT_Sensitivity                                        0x0903 // Specifies the sensitivity of the RVDT. This value is in the units you specify with DAQmx_AI_RVDT_SensitivityUnits. Refer to the sensor documentation to determine this value.
#define DAQmx_AI_RVDT_SensitivityUnits                                   0x219B // Specifies the units of DAQmx_AI_RVDT_Sensitivity.
...
#define DAQmx_AI_EddyCurrentProxProbe_Sensitivity                        0x2ABE // Specifies the sensitivity of the eddy current proximity probe . This value is in the units you specify with DAQmx_AI_EddyCurrentProxProbe_SensitivityUnits. Refer to the sensor documentation to determine this value.
#define DAQmx_AI_EddyCurrentProxProbe_SensitivityUnits                   0x2ABF // Specifies the units of DAQmx_AI_EddyCurrentProxProbe_Sensitivity.
#define DAQmx_AI_SoundPressure_MaxSoundPressureLvl                       0x223A // Specifies the maximum instantaneous sound pressure level you expect to measure. This value is in decibels, referenced to 20 micropascals. NI-DAQmx uses the maximum sound pressure level to calculate values in pascals for DAQmx_AI_Max and DAQmx_AI_Min for the channel.
...
#define DAQmx_AI_Accel_Sensitivity                                       0x0692 // Specifies the sensitivity of the accelerometer. This value is in the units you specify with DAQmx_AI_Accel_SensitivityUnits. Refer to the sensor documentation to determine this value.
#define DAQmx_AI_Accel_SensitivityUnits                                  0x219C // Specifies the units of DAQmx_AI_Accel_Sensitivity.
...
#define DAQmx_AI_Velocity_IEPESensor_Sensitivity                         0x2FF6 // Specifies the sensitivity of the IEPE velocity sensor connected to the channel. Specify this value in the unit indicated by DAQmx_AI_Velocity_IEPESensor_SensitivityUnits.
#define DAQmx_AI_Velocity_IEPESensor_SensitivityUnits                    0x2FF7 // Specifies the units for DAQmx_AI_Velocity_IEPESensor_Sensitivity.
#define DAQmx_AI_Force_Units                                             0x2F75 // Specifies in which unit to return force or load measurements from the channel.
#define DAQmx_AI_Force_IEPESensor_Sensitivity                            0x2F81 // Specifies the sensitivity of the IEPE force sensor connected to the channel. Specify this value in the unit indicated by DAQmx_AI_Force_IEPESensor_SensitivityUnits.
#define DAQmx_AI_Force_IEPESensor_SensitivityUnits                       0x2F82 // Specifies the units for DAQmx_AI_Force_IEPESensor_Sensitivity.
...
#define DAQmx_AI_Bridge_TwoPointLin_First_ElectricalVal                  0x2F8A // Specifies the first electrical value, corresponding to DAQmx_AI_Bridge_TwoPointLin_First_PhysicalVal. Specify this value in the unit indicated by DAQmx_AI_Bridge_ElectricalUnits.
#define DAQmx_AI_Bridge_TwoPointLin_First_PhysicalVal                    0x2F8B // Specifies the first physical value, corresponding to DAQmx_AI_Bridge_TwoPointLin_First_ElectricalVal. Specify this value in the unit indicated by DAQmx_AI_Bridge_PhysicalUnits.
#define DAQmx_AI_Bridge_TwoPointLin_Second_ElectricalVal                 0x2F8C // Specifies the second electrical value, corresponding to DAQmx_AI_Bridge_TwoPointLin_Second_PhysicalVal. Specify this value in the unit indicated by DAQmx_AI_Bridge_ElectricalUnits.
#define DAQmx_AI_Bridge_TwoPointLin_Second_PhysicalVal                   0x2F8D // Specifies the second physical value, corresponding to DAQmx_AI_Bridge_TwoPointLin_Second_ElectricalVal. Specify this value in the unit indicated by DAQmx_AI_Bridge_PhysicalUnits.
#define DAQmx_AI_Bridge_Table_ElectricalVals                             0x2F8E // Specifies the array of electrical values that map to the values in DAQmx_AI_Bridge_Table_PhysicalVals. Specify this value in the unit indicated by DAQmx_AI_Bridge_ElectricalUnits.
#define DAQmx_AI_Bridge_Table_PhysicalVals                               0x2F8F // Specifies the array of physical values that map to the values in DAQmx_AI_Bridge_Table_ElectricalVals. Specify this value in the unit indicated by DAQmx_AI_Bridge_PhysicalUnits.
...
#define DAQmx_AI_Bridge_ShuntCal_Enable                                  0x0094 // Specifies whether to enable a shunt calibration switch. Use DAQmx_AI_Bridge_ShuntCal_Select to select the switch(es) to enable.
#define DAQmx_AI_Bridge_ShuntCal_Select                                  0x21D5 // Specifies which shunt calibration switch(es) to enable.  Use DAQmx_AI_Bridge_ShuntCal_Enable to enable the switch(es) you specify with this property.
...
#define DAQmx_AI_Excit_Val                                               0x17F5 // Specifies the amount of excitation that the sensor requires. If DAQmx_AI_Excit_VoltageOrCurrent is  DAQmx_Val_Voltage, this value is in volts. If DAQmx_AI_Excit_VoltageOrCurrent is  DAQmx_Val_Current, this value is in amperes.
#define DAQmx_AI_Excit_UseForScaling                                     0x17FC // Specifies if NI-DAQmx divides the measurement by the excitation. You should typically set this property to TRUE for ratiometric transducers. If you set this property to TRUE, set DAQmx_AI_Max and DAQmx_AI_Min to reflect the scaling.
...
#define DAQmx_AI_Lowpass_SwitchCap_ExtClkFreq                            0x1885 // Specifies the frequency of the external clock when you set DAQmx_AI_Lowpass_SwitchCap_ClkSrc to DAQmx_Val_External.  NI-DAQmx uses this frequency to set the pre- and post- filters on the SCXI-1141, SCXI-1142, and SCXI-1143. On those devices, NI-DAQmx determines the filter cutoff by using the equation f/(100*n), where f is the external frequency, and n is the external clock divisor. Refer to the SCXI-1141/1142/1143...
#define DAQmx_AI_Lowpass_SwitchCap_ExtClkDiv                             0x1886 // Specifies the divisor for the external clock when you set DAQmx_AI_Lowpass_SwitchCap_ClkSrc to DAQmx_Val_External. On the SCXI-1141, SCXI-1142, and SCXI-1143, NI-DAQmx determines the filter cutoff by using the equation f/(100*n), where f is the external frequency, and n is the external clock divisor. Refer to the SCXI-1141/1142/1143 User Manual for more information.
...
#define DAQmx_AI_FilterDelay                                             0x2FED // Indicates the amount of time between when the ADC samples data and when the sample is read by the host device. This value is in the units you specify with DAQmx_AI_FilterDelayUnits.
#define DAQmx_AI_FilterDelayUnits                                        0x3071 // Specifies the units of DAQmx_AI_FilterDelay and DAQmx_AI_FilterDelayAdjustment.
#define DAQmx_AI_RemoveFilterDelay                                       0x2FBD // Specifies if filter delay removal is enabled on the device.
#define DAQmx_AI_FilterDelayAdjustment                                   0x3074 // Specifies the amount of filter delay that gets removed if DAQmx_AI_RemoveFilterDelay is enabled. This delay adjustment is in addition to the value indicated by DAQmx_AI_FilterDelay. This delay adjustment is in the units you specify with DAQmx_AI_FilterDelayUnits.
...
#define DAQmx_AI_ResolutionUnits                                         0x1764 // Indicates the units of DAQmx_AI_Resolution.
#define DAQmx_AI_Resolution                                              0x1765 // Indicates the resolution of the analog-to-digital converter of the channel. This value is in the units you specify with DAQmx_AI_ResolutionUnits.
...
#define DAQmx_AI_DCOffset                                                0x2A89 // Specifies the DC value to add to the input range of the device. Use DAQmx_AI_Rng_High and DAQmx_AI_Rng_Low to specify the input range. This offset is in the native units of the device .
#define DAQmx_AI_Gain                                                    0x1818 // Specifies a gain factor to apply to the channel.
#define DAQmx_AI_SampAndHold_Enable                                      0x181A // Specifies whether to enable the sample and hold circuitry of the device. When you disable sample and hold circuitry, a small voltage offset might be introduced into the signal.  You can eliminate this offset by using DAQmx_AI_AutoZeroMode to perform an auto zero on the channel.
...
#define DAQmx_AI_DataXferCustomThreshold                                 0x230C // Specifies the number of samples that must be in the FIFO to transfer data from the device if DAQmx_AI_DataXferReqCond is DAQmx_Val_OnbrdMemCustomThreshold.
...
#define DAQmx_AI_LossyLSBRemoval_CompressedSampSize                      0x22D9 // Specifies the number of bits to return in a raw sample when DAQmx_AI_RawDataCompressionType is set to DAQmx_Val_LossyLSBRemoval.
...
#define DAQmx_AO_FuncGen_FMDeviation                                     0x2A23 // Specifies the FM deviation in hertz per volt when DAQmx_AO_FuncGen_ModulationType is DAQmx_Val_FM.
...
#define DAQmx_AO_ResolutionUnits                                         0x182B // Specifies the units of DAQmx_AO_Resolution.
#define DAQmx_AO_Resolution                                              0x182C // Indicates the resolution of the digital-to-analog converter of the channel. This value is in the units you specify with DAQmx_AO_ResolutionUnits.
...
#define DAQmx_AO_DAC_Ref_ConnToGnd                                       0x0130 // Specifies whether to ground the internal DAC reference. Grounding the internal DAC reference has the effect of grounding all analog output channels and stopping waveform generation across all analog output channels regardless of whether the channels belong to the current task. You can ground the internal DAC reference only when DAQmx_AO_DAC_Ref_Src is DAQmx_Val_Internal and DAQmx_AO_DAC_Ref_AllowConnToGnd is TRUE....
#define DAQmx_AO_DAC_Ref_AllowConnToGnd                                  0x1830 // Specifies whether to allow grounding the internal DAC reference at run time. You must set this property to TRUE and set DAQmx_AO_DAC_Ref_Src to DAQmx_Val_Internal before you can set DAQmx_AO_DAC_Ref_ConnToGnd to TRUE.
...
#define DAQmx_AO_DAC_Ref_ExtSrc                                          0x2252 // Specifies the source of the DAC reference voltage if DAQmx_AO_DAC_Ref_Src is DAQmx_Val_External. The valid sources for this signal vary by device.
...
#define DAQmx_AO_DAC_Offset_ExtSrc                                       0x2254 // Specifies the source of the DAC offset voltage if DAQmx_AO_DAC_Offset_Src is DAQmx_Val_External. The valid sources for this signal vary by device.
...
#define DAQmx_AO_FilterDelay                                             0x3075 // Specifies the amount of time between when the sample is written by the host device and when the sample is output by the DAC. This value is in the units you specify with DAQmx_AO_FilterDelayUnits.
#define DAQmx_AO_FilterDelayUnits                                        0x3076 // Specifies the units of DAQmx_AO_FilterDelay and DAQmx_AO_FilterDelayAdjustment.
...
#define DAQmx_DO_Overcurrent_AutoReenable                                0x2A86 // Specifies whether to automatically reenable channels after they no longer exceed the current limit specified by DAQmx_DO_Overcurrent_Limit.
#define DAQmx_DO_Overcurrent_ReenablePeriod                              0x2A87 // Specifies the delay in seconds between the time a channel no longer exceeds the current limit and the reactivation of that channel, if DAQmx_DO_Overcurrent_AutoReenable is TRUE.
...
#define DAQmx_CI_Freq_Div                                                0x0147 // Specifies the value by which to divide the input signal if  DAQmx_CI_Freq_MeasMeth is DAQmx_Val_LargeRng2Ctr. The larger the divisor, the more accurate the measurement. However, too large a value could cause the count register to roll over, which results in an incorrect measurement.
...
#define DAQmx_CI_Period_Div                                              0x192E // Specifies the value by which to divide the input signal if DAQmx_CI_Period_MeasMeth is DAQmx_Val_LargeRng2Ctr. The larger the divisor, the more accurate the measurement. However, too large a value could cause the count register to roll over, which results in an incorrect measurement.
...
#define DAQmx_CI_CountEdges_DirTerm                                      0x21E1 // Specifies the source terminal of the digital signal that controls the count direction if DAQmx_CI_CountEdges_Dir is DAQmx_Val_ExtControlled.
...
#define DAQmx_CI_CountEdges_CountReset_Enable                            0x2FAF // Specifies whether to reset the count on the active edge specified with DAQmx_CI_CountEdges_CountReset_Term.
...
#define DAQmx_CI_AngEncoder_InitialAngle                                 0x0881 // Specifies the starting angle of the encoder. This value is in the units you specify with DAQmx_CI_AngEncoder_Units.
...
#define DAQmx_CI_LinEncoder_DistPerPulse                                 0x0911 // Specifies the distance to measure for each pulse the encoder generates on signal A or signal B. This value is in the units you specify with DAQmx_CI_LinEncoder_Units.
#define DAQmx_CI_LinEncoder_InitialPos                                   0x0915 // Specifies the position of the encoder when the measurement begins. This value is in the units you specify with DAQmx_CI_LinEncoder_Units.
...
#define DAQmx_CI_Encoder_ZIndexVal                                       0x0888 // Specifies the value to which to reset the measurement when signal Z is high and signal A and signal B are at the states you specify with DAQmx_CI_Encoder_ZIndexPhase. Specify this value in the units of the measurement.
...
#define DAQmx_CI_Timestamp_InitialSeconds                                0x22B4 // Specifies the number of seconds that elapsed since the beginning of the current year. This value is ignored if  DAQmx_CI_GPS_SyncMethod is DAQmx_Val_IRIGB.
...
#define DAQmx_CI_DupCountPrevent                                         0x21AC // Specifies whether to enable duplicate count prevention for the channel. Duplicate count prevention is enabled by default. Setting  DAQmx_CI_Prescaler disables duplicate count prevention unless you explicitly enable it.
#define DAQmx_CI_Prescaler                                               0x2239 // Specifies the divisor to apply to the signal you connect to the counter source terminal. Scaled data that you read takes this setting into account. You should use a prescaler only when you connect an external signal to the counter source terminal and when that signal has a higher frequency than the fastest onboard timebase. Setting this value disables duplicate count prevention unless you explicitly set DAQmx_CI_D...
...
#define DAQmx_CO_Pulse_HighTime                                          0x18BA // Specifies the amount of time that the pulse is at a high voltage. This value is in the units you specify with DAQmx_CO_Pulse_Time_Units or when you create the channel.
#define DAQmx_CO_Pulse_LowTime                                           0x18BB // Specifies the amount of time that the pulse is at a low voltage. This value is in the units you specify with DAQmx_CO_Pulse_Time_Units or when you create the channel.
...
#define DAQmx_CO_Pulse_Freq                                              0x1178 // Specifies the frequency of the pulses to generate. This value is in the units you specify with DAQmx_CO_Pulse_Freq_Units or when you create the channel.
...
#define DAQmx_Exported_SampClk_Pulse_Polarity                            0x1664 // Specifies the polarity of the exported Sample Clock if DAQmx_Exported_SampClk_OutputBehavior is DAQmx_Val_Pulse.
...
#define DAQmx_Exported_AdvTrig_Pulse_WidthUnits                          0x1647 // Specifies the units of DAQmx_Exported_AdvTrig_Pulse_Width.
#define DAQmx_Exported_AdvTrig_Pulse_Width                               0x1648 // Specifies the width of an exported Advance Trigger pulse. Specify this value in the units you specify with DAQmx_Exported_AdvTrig_Pulse_WidthUnits.
...
#define DAQmx_Exported_CtrOutEvent_Pulse_Polarity                        0x1718 // Specifies the polarity of the pulses at the output terminal of the counter when DAQmx_Exported_CtrOutEvent_OutputBehavior is DAQmx_Val_Pulse. NI-DAQmx ignores this property if DAQmx_Exported_CtrOutEvent_OutputBehavior is DAQmx_Val_Toggle.
#define DAQmx_Exported_CtrOutEvent_Toggle_IdleState                      0x186A // Specifies the initial state of the output terminal of the counter when DAQmx_Exported_CtrOutEvent_OutputBehavior is DAQmx_Val_Toggle. The terminal enters this state when NI-DAQmx commits the task.
...
#define DAQmx_Exported_HshkEvent_Interlocked_AssertedLvl                 0x22BD // Specifies the asserted level of the exported Handshake Event if DAQmx_Exported_HshkEvent_OutputBehavior is DAQmx_Val_Interlocked.
#define DAQmx_Exported_HshkEvent_Interlocked_AssertOnStart               0x22BE // Specifies to assert the Handshake Event when the task starts if DAQmx_Exported_HshkEvent_OutputBehavior is DAQmx_Val_Interlocked.
#define DAQmx_Exported_HshkEvent_Interlocked_DeassertDelay               0x22BF // Specifies in seconds the amount of time to wait after the Handshake Trigger asserts before deasserting the Handshake Event if DAQmx_Exported_HshkEvent_OutputBehavior is DAQmx_Val_Interlocked.
#define DAQmx_Exported_HshkEvent_Pulse_Polarity                          0x22C0 // Specifies the polarity of the exported Handshake Event if DAQmx_Exported_HshkEvent_OutputBehavior is DAQmx_Val_Pulse.
#define DAQmx_Exported_HshkEvent_Pulse_Width                             0x22C1 // Specifies in seconds the pulse width of the exported Handshake Event if DAQmx_Exported_HshkEvent_OutputBehavior is DAQmx_Val_Pulse.
...
#define DAQmx_Exported_RdyForXferEvent_DeassertCondCustomThreshold       0x2964 // Specifies in samples the threshold below which the Ready for Transfer Event deasserts. This threshold is an amount of space available in the onboard memory of the device. DAQmx_Exported_RdyForXferEvent_DeassertCond must be DAQmx_Val_OnbrdMemCustomThreshold to use a custom threshold.
...
#define DAQmx_Dev_AI_SupportedMeasTypes                                  0x2FD2 // Indicates the measurement types supported by the physical channels of the device. Refer to DAQmx_PhysicalChan_AI_SupportedMeasTypes for information on specific channels.
...
#define DAQmx_Dev_AI_MaxMultiChanRate                                    0x298D // Indicates the maximum sampling rate for an analog input task from this device. To find the maximum rate for the task, take the minimum of DAQmx_Dev_AI_MaxSingleChanRate or the indicated sampling rate of this device divided by the number of channels to acquire data from (including cold-junction compensation and autozero channels).
...
#define DAQmx_Dev_AI_VoltageIntExcitDiscreteVals                         0x29C9 // Indicates the set of discrete internal voltage excitation values supported by this device. If the device supports ranges of internal excitation values, use DAQmx_Dev_AI_VoltageIntExcitRangeVals to determine supported excitation values.
...
#define DAQmx_Dev_AI_LowpassCutoffFreqDiscreteVals                       0x2995 // Indicates the set of discrete lowpass cutoff frequencies supported by this device. If the device supports ranges of lowpass cutoff frequencies, use DAQmx_Dev_AI_LowpassCutoffFreqRangeVals to determine supported frequencies.
...
#define DAQmx_Dev_AO_SupportedOutputTypes                                0x2FD3 // Indicates the generation types supported by the physical channels of the device. Refer to DAQmx_PhysicalChan_AO_SupportedOutputTypes for information on specific channels.
...
#define DAQmx_Dev_CI_SupportedMeasTypes                                  0x2FD4 // Indicates the measurement types supported by the physical channels of the device. Refer to DAQmx_PhysicalChan_CI_SupportedMeasTypes for information on specific channels.
...
#define DAQmx_Dev_CO_SupportedOutputTypes                                0x2FD5 // Indicates the generation types supported by the physical channels of the device. Refer to DAQmx_PhysicalChan_CO_SupportedOutputTypes for information on specific channels.
...
//********** Read Attributes **********
#define DAQmx_Read_RelativeTo                                            0x190A // Specifies the point in the buffer at which to begin a read operation. If you also specify an offset with DAQmx_Read_Offset, the read operation begins at that offset relative to the point you select with this property. The default value is DAQmx_Val_CurrReadPos unless you configure a Reference Trigger for the task. If you configure a Reference Trigger, the default value is DAQmx_Val_FirstPretrigSamp.
#define DAQmx_Read_Offset                                                0x190B // Specifies an offset in samples per channel at which to begin a read operation. This offset is relative to the location you specify with DAQmx_Read_RelativeTo.
...
#define DAQmx_Read_CommonModeRangeErrorChansExist                        0x2A98 // Indicates if the device(s) detected a common mode range violation for any virtual channel in the task. Common mode range violation occurs when the voltage of either the positive terminal or negative terminal to ground are out of range. Reading this property clears the common mode range violation status for all channels in the task. You must read this property before you read DAQmx_Read_CommonModeRangeErrorChans. O...
#define DAQmx_Read_CommonModeRangeErrorChans                             0x2A99 // Indicates a list of names of any virtual channels in the task for which the device(s) detected a common mode range violation. You must read DAQmx_Read_CommonModeRangeErrorChansExist before you read this property. Otherwise, you will receive an error.
#define DAQmx_Read_OvercurrentChansExist                                 0x29E6 // Indicates if the device(s) detected an overcurrent condition for any virtual channel in the task. Reading this property clears the overcurrent status for all channels in the task. You must read this property before you read DAQmx_Read_OvercurrentChans. Otherwise, you will receive an error.
#define DAQmx_Read_OvercurrentChans                                      0x29E7 // Indicates a list of names of any virtual channels in the task for which the device(s) detected an overcurrent condition. You must read DAQmx_Read_OvercurrentChansExist before you read this property. Otherwise, you will receive an error. On some devices, you must restart the task for all overcurrent channels to recover.
...
#define DAQmx_Read_OvertemperatureChans                                  0x3082 // Indicates a list of names of any overtemperature virtual channels. You must read DAQmx_Read_OvertemperatureChansExist before you read this property. Otherwise, you will receive an error.
...
#define DAQmx_Read_OpenCurrentLoopChans                                  0x2A0A // Indicates a list of names of any virtual channels in the task for which the device(s) detected an open current loop. You must read DAQmx_Read_OpenCurrentLoopChansExist before you read this property. Otherwise, you will receive an error.
...
#define DAQmx_Read_OpenThrmcplChans                                      0x2A97 // Indicates a list of names of any virtual channels in the task for which the device(s) detected an open thermcouple. You must read DAQmx_Read_OpenThrmcplChansExist before you read this property. Otherwise, you will receive an error.
#define DAQmx_Read_OverloadedChansExist                                  0x2174 // Indicates if the device(s) detected an overload in any virtual channel in the task. Reading this property clears the overload status for all channels in the task. You must read this property before you read DAQmx_Read_OverloadedChans. Otherwise, you will receive an error.
#define DAQmx_Read_OverloadedChans                                       0x2175 // Indicates a list of names of any overloaded virtual channels in the task. You must read DAQmx_Read_OverloadedChansExist before you read this property. Otherwise, you will receive an error.
#define DAQmx_Read_AccessoryInsertionOrRemovalDetected                   0x2F70 // Indicates if any device(s) in the task detected the insertion or removal of an accessory since the task started. Reading this property clears the accessory change status for all channels in the task. You must read this property before you read DAQmx_Read_DevsWithInsertedOrRemovedAccessories. Otherwise, you will receive an error.
#define DAQmx_Read_DevsWithInsertedOrRemovedAccessories                  0x2F71 // Indicates the names of any devices that detected the insertion or removal of an accessory since the task started. You must read DAQmx_Read_AccessoryInsertionOrRemovalDetected before you read this property. Otherwise, you will receive an error.
...
#define DAQmx_Read_NumChans                                              0x217B // Indicates the number of channels that an NI-DAQmx Read function reads from the task. This value is the number of channels in the task or the number of channels you specify with DAQmx_Read_ChannelsToRead.
...
#define DAQmx_Read_SleepTime                                             0x22B0 // Specifies in seconds the amount of time to sleep after checking for available samples if DAQmx_Read_WaitMode is DAQmx_Val_Sleep.

//********** Real-Time Attributes **********
#define DAQmx_RealTime_ConvLateErrorsToWarnings                          0x22EE // Specifies if DAQmxWaitForNextSampleClock() and an NI-DAQmx Read function convert late errors to warnings. NI-DAQmx returns no late warnings or errors until the number of warmup iterations you specify with DAQmx_RealTime_NumOfWarmupIters execute.
...
#define DAQmx_SwitchDev_Settled                                          0x1243 // Indicates when DAQmx_SwitchDev_SettlingTime expires.
#define DAQmx_SwitchDev_RelayList                                        0x17DC // Indicates a comma-delimited list of relay names.
#define DAQmx_SwitchDev_NumRelays                                        0x18E6 // Indicates the number of relays on the device. This value matches the number of relay names in DAQmx_SwitchDev_RelayList.
...
#define DAQmx_SwitchDev_NumSwitchChans                                   0x18E8 // Indicates the number of switch channels for the current topology of the device. This value matches the number of channel names in DAQmx_SwitchDev_SwitchChanList.
...
#define DAQmx_Scale_Map_ScaledMax                                        0x1229 // Specifies the largest value in the range of scaled values. NI-DAQmx maps this value to DAQmx_Scale_Map_PreScaledMax. Reads coerce samples that are larger than this value to match this value. Writes generate errors for samples that are larger than this value.
#define DAQmx_Scale_Map_PreScaledMax                                     0x1231 // Specifies the largest value in the range of pre-scaled values. NI-DAQmx maps this value to DAQmx_Scale_Map_ScaledMax.
#define DAQmx_Scale_Map_ScaledMin                                        0x1230 // Specifies the smallest value in the range of scaled values. NI-DAQmx maps this value to DAQmx_Scale_Map_PreScaledMin. Reads coerce samples that are smaller than this value to match this value. Writes generate errors for samples that are smaller than this value.
#define DAQmx_Scale_Map_PreScaledMin                                     0x1232 // Specifies the smallest value in the range of pre-scaled values. NI-DAQmx maps this value to DAQmx_Scale_Map_ScaledMin.
...
#define DAQmx_Scale_Table_ScaledVals                                     0x1236 // Specifies an array of scaled values. These values map directly to the values in DAQmx_Scale_Table_PreScaledVals.
#define DAQmx_Scale_Table_PreScaledVals                                  0x1237 // Specifies an array of pre-scaled values. These values map directly to the values in DAQmx_Scale_Table_ScaledVals.
...
#define DAQmx_SampQuant_SampPerChan                                      0x1310 // Specifies the number of samples to acquire or generate for each channel if DAQmx_SampQuant_SampMode is DAQmx_Val_FiniteSamps. If DAQmx_SampQuant_SampMode is DAQmx_Val_ContSamps, NI-DAQmx uses this value to determine the buffer size.
...
#define DAQmx_SampClk_Term                                               0x2F1B // Indicates the name of the internal Sample Clock terminal for the task. This property does not return the name of the Sample Clock source terminal specified with DAQmx_SampClk_Src.
...
#define DAQmx_SampClkTimebase_Term                                       0x2F1C // Indicates the name of the internal Sample Clock Timebase terminal for the task. This property does not return the name of the Sample Clock Timebase source terminal specified with DAQmx_SampClk_Timebase_Src.
...
#define DAQmx_ChangeDetect_DI_Tristate                                   0x2EFA // Specifies whether to tristate lines specified with DAQmx_ChangeDetect_DI_RisingEdgePhysicalChans and DAQmx_ChangeDetect_DI_FallingEdgePhysicalChans that are not in a virtual channel in the task. If you set this property to TRUE, NI-DAQmx tristates rising/falling edge lines that are not in a virtual channel in the task. If you set this property to FALSE, NI-DAQmx does not modify the configuration of rising/falling ...
...
#define DAQmx_DelayFromSampClk_DelayUnits                                0x1304 // Specifies the units of DAQmx_DelayFromSampClk_Delay.
#define DAQmx_DelayFromSampClk_Delay                                     0x1317 // Specifies the amount of time to wait after receiving a Sample Clock edge before beginning to acquire the sample. This value is in the units you specify with DAQmx_DelayFromSampClk_DelayUnits.
...
#define DAQmx_DigPattern_StartTrig_When                                  0x1411 // Specifies whether the Start Trigger occurs when the physical channels specified with DAQmx_DigPattern_StartTrig_Src match or differ from the digital pattern specified with DAQmx_DigPattern_StartTrig_Pattern.
...
#define DAQmx_AnlgEdge_StartTrig_Lvl                                     0x1396 // Specifies at what threshold in the units of the measurement or generation to start acquiring or generating samples. Use DAQmx_AnlgEdge_StartTrig_Slope to specify on which slope to trigger on this threshold.
#define DAQmx_AnlgEdge_StartTrig_Hyst                                    0x1395 // Specifies a hysteresis level in the units of the measurement or generation. If DAQmx_AnlgEdge_StartTrig_Slope is DAQmx_Val_RisingSlope, the trigger does not deassert until the source signal passes below  DAQmx_AnlgEdge_StartTrig_Lvl minus the hysteresis. If DAQmx_AnlgEdge_StartTrig_Slope is DAQmx_Val_FallingSlope, the trigger does not deassert until the source signal passes above DAQmx_AnlgEdge_StartTrig_Lvl plus ...
...
#define DAQmx_AnlgWin_StartTrig_When                                     0x1401 // Specifies whether the task starts acquiring or generating samples when the signal enters or leaves the window you specify with DAQmx_AnlgWin_StartTrig_Btm and DAQmx_AnlgWin_StartTrig_Top.
...
#define DAQmx_StartTrig_Delay                                            0x1856 // Specifies an amount of time to wait after the Start Trigger is received before acquiring or generating the first sample. This value is in the units you specify with DAQmx_StartTrig_DelayUnits.
#define DAQmx_StartTrig_DelayUnits                                       0x18C8 // Specifies the units of DAQmx_StartTrig_Delay.
...
#define DAQmx_RefTrig_PretrigSamples                                     0x1445 // Specifies the minimum number of pretrigger samples to acquire from each channel before recognizing the reference trigger. Post-trigger samples per channel are equal to DAQmx_SampQuant_SampPerChan minus the number of pretrigger samples per channel.
...
#define DAQmx_DigPattern_RefTrig_When                                    0x1438 // Specifies whether the Reference Trigger occurs when the physical channels specified with DAQmx_DigPattern_RefTrig_Src match or differ from the digital pattern specified with DAQmx_DigPattern_RefTrig_Pattern.
...
#define DAQmx_AnlgEdge_RefTrig_Lvl                                       0x1422 // Specifies in the units of the measurement the threshold at which the Reference Trigger occurs.  Use DAQmx_AnlgEdge_RefTrig_Slope to specify on which slope to trigger at this threshold.
#define DAQmx_AnlgEdge_RefTrig_Hyst                                      0x1421 // Specifies a hysteresis level in the units of the measurement. If DAQmx_AnlgEdge_RefTrig_Slope is DAQmx_Val_RisingSlope, the trigger does not deassert until the source signal passes below DAQmx_AnlgEdge_RefTrig_Lvl minus the hysteresis. If DAQmx_AnlgEdge_RefTrig_Slope is DAQmx_Val_FallingSlope, the trigger does not deassert until the source signal passes above DAQmx_AnlgEdge_RefTrig_Lvl plus the hysteresis. Hystere...
...
#define DAQmx_AnlgWin_RefTrig_When                                       0x1427 // Specifies whether the Reference Trigger occurs when the source signal enters the window or when it leaves the window. Use DAQmx_AnlgWin_RefTrig_Btm and DAQmx_AnlgWin_RefTrig_Top to specify the window.
...
#define DAQmx_RefTrig_AutoTriggered                                      0x2EC2 // Indicates whether a completed acquisition was triggered by the auto trigger. If an acquisition has not completed after the task starts, this property returns FALSE. This property is only applicable when DAQmx_RefTrig_AutoTrigEnable  is TRUE.
...
#define DAQmx_AnlgLvl_PauseTrig_When                                     0x1371 // Specifies whether the task pauses above or below the threshold you specify with DAQmx_AnlgLvl_PauseTrig_Lvl.
#define DAQmx_AnlgLvl_PauseTrig_Lvl                                      0x1369 // Specifies the threshold at which to pause the task. Specify this value in the units of the measurement or generation. Use DAQmx_AnlgLvl_PauseTrig_When to specify whether the task pauses above or below this threshold.
#define DAQmx_AnlgLvl_PauseTrig_Hyst                                     0x1368 // Specifies a hysteresis level in the units of the measurement or generation. If DAQmx_AnlgLvl_PauseTrig_When is DAQmx_Val_AboveLvl, the trigger does not deassert until the source signal passes below DAQmx_AnlgLvl_PauseTrig_Lvl minus the hysteresis. If DAQmx_AnlgLvl_PauseTrig_When is DAQmx_Val_BelowLvl, the trigger does not deassert until the source signal passes above DAQmx_AnlgLvl_PauseTrig_Lvl plus the hysteresis...
...
#define DAQmx_AnlgWin_PauseTrig_When                                     0x1374 // Specifies whether the task pauses while the trigger signal is inside or outside the window you specify with DAQmx_AnlgWin_PauseTrig_Btm and DAQmx_AnlgWin_PauseTrig_Top.
...
#define DAQmx_DigPattern_PauseTrig_When                                  0x2170 // Specifies if the Pause Trigger occurs when the physical channels specified with DAQmx_DigPattern_PauseTrig_Src match or differ from the digital pattern specified with DAQmx_DigPattern_PauseTrig_Pattern.
...
//********** Write Attributes **********
#define DAQmx_Write_RelativeTo                                           0x190C // Specifies the point in the buffer at which to write data. If you also specify an offset with DAQmx_Write_Offset, the write operation begins at that offset relative to this point you select with this property.
#define DAQmx_Write_Offset                                               0x190D // Specifies in samples per channel an offset at which a write operation begins. This offset is relative to the location you specify with DAQmx_Write_RelativeTo.
...
#define DAQmx_Write_OvercurrentChansExist                                0x29E8 // Indicates if the device(s) detected an overcurrent condition for any channel in the task. Reading this property clears the overcurrent status for all channels in the task. You must read this property before you read DAQmx_Write_OvercurrentChans. Otherwise, you will receive an error.
#define DAQmx_Write_OvercurrentChans                                     0x29E9 // Indicates a list of names of any virtual channels in the task for which an overcurrent condition has been detected. You must read DAQmx_Write_OvercurrentChansExist before you read this property. Otherwise, you will receive an error.
...
#define DAQmx_Write_OvertemperatureChans                                 0x3083 // Indicates a list of names of any overtemperature virtual channels. You must read DAQmx_Write_OvertemperatureChansExist before you read this property. Otherwise, you will receive an error. The list of names may be empty if the device cannot determine the source of the overtemperature.
...
#define DAQmx_Write_OverloadedChans                                      0x3085 // Indicates a list of names of any overloaded virtual channels in the task. You must read DAQmx_Write_OverloadedChansExist before you read this property. Otherwise, you will receive an error.
#define DAQmx_Write_OpenCurrentLoopChansExist                            0x29EA // Indicates if the device(s) detected an open current loop for any channel in the task. Reading this property clears the open current loop status for all channels in the task. You must read this property before you read DAQmx_Write_OpenCurrentLoopChans. Otherwise, you will receive an error.
#define DAQmx_Write_OpenCurrentLoopChans                                 0x29EB // Indicates a list of names of any virtual channels in the task for which the device(s) detected an open current loop. You must read DAQmx_Write_OpenCurrentLoopChansExist before you read this property. Otherwise, you will receive an error.
#define DAQmx_Write_PowerSupplyFaultChansExist                           0x29EC // Indicates if the device(s) detected a power supply fault for any channel in the task. Reading this property clears the power supply fault status for all channels in the task. You must read this property before you read DAQmx_Write_PowerSupplyFaultChans. Otherwise, you will receive an error.
#define DAQmx_Write_PowerSupplyFaultChans                                0x29ED // Indicates a list of names of any virtual channels in the task that have a power supply fault. You must read DAQmx_Write_PowerSupplyFaultChansExist before you read this property. Otherwise, you will receive an error.
...
#define DAQmx_Write_SleepTime                                            0x22B2 // Specifies in seconds the amount of time to sleep after checking for available buffer space if DAQmx_Write_WaitMode is DAQmx_Val_Sleep.
#define DAQmx_Write_NextWriteIsLast                                      0x296C // Specifies that the next samples written are the last samples you want to generate. Use this property when performing continuous generation to prevent underflow errors after writing the last sample. DAQmx_Write_RegenMode must be DAQmx_Val_DoNotAllowRegen to use this property.
...
#define DAQmx_Write_AccessoryInsertionOrRemovalDetected                  0x3053 // Indicates if any devices in the task detected the insertion or removal of an accessory since the task started. Reading this property clears the accessory change status for all channels in the task. You must read this property before you read DAQmx_Write_DevsWithInsertedOrRemovedAccessories. Otherwise, you will receive an error.
#define DAQmx_Write_DevsWithInsertedOrRemovedAccessories                 0x3054 // Indicates the names of any devices that detected the insertion or removal of an accessory since the task started. You must read DAQmx_Write_AccessoryInsertionOrRemovalDetected before you read this property. Otherwise, you will receive an error.
...
#define DAQmx_PhysicalChan_TEDS_TemplateIDs                              0x228F // Indicates the IDs of the templates in the bitstream in DAQmx_PhysicalChan_TEDS_BitStream.

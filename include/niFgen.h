 ...
 *---------------------------------------------------------------------------
 *   Copyright (c) National Instruments 1998-2005.  All Rights Reserved.         
 *---------------------------------------------------------------------------
 *                                                                          
 * Title:    niFgen.h                                        
 ...
 ****************************************************************************/
#define NIFGEN_MAJOR_VERSION       2     /* Instrument driver major version */
#define NIFGEN_MINOR_VERSION       900   /* Instrument driver minor version */
...
ViStatus _VI_FUNC niFgen_QueryFreqListCapabilities(
   ViSession vi,
   ViInt32 *maxNumFLists,
   ViInt32 *minFListLength,
   ViInt32 *maxFListLength,
   ViReal64 *minFListDuration,
   ViReal64 *maxFListDuration,
   ViReal64 *fListDurationQuantum);
